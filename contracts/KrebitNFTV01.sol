    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(
        ...
        __KrebitNFTV01_init(uri, collectionURI, initialPrice, krebitAddress);
    }

    function __KrebitNFTV01_init(
        string memory uri,
        string memory collectionURI,
        uint256 initialPrice,
        address krebitAddress
    ...
    function __KrebitNFTV01_init_unchained() internal onlyInitializing {
