...
describe("KrebitNFTV01", function () {
  before(async function () {
    ...
    this.KrebitNFTV01 = await ethers.getContractFactory("KrebitNFTV01");
    ...
    console.log("KrebitNFTV01 deployed to:", this.krbNFT.address);
    ...
    const KrebitNFTV01Subject = await ethers.getContractFactory(
      "KrebitNFTV01",
      this.subject
    );
    this.krbNFTSubject = await KrebitNFTV01Subject.attach(this.krbNFT.address);
